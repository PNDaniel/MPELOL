...
public class PEAST {
	...
	public Schedule GHCM(Schedule split, int maximum_sequence_length, int current_round, double current_temperature) {
		...
		Matchup object_to_move = randomObject(split); // Set objectToMove =
														// RandomObject(S)
...
//		System.out.println("FirstCell: " + firstCell);
		while (index < maximum_sequence_length) {
			 ...
			 * currentCost of the iteration is the full cost(value) of a split
			 * System.out.println("Cost of iteration " + index + " is: " +
			 * previousIterationCost);
			 */
